...
export const ExpiredVerificationCodeException = () =>
  new UnprocessableEntityException([
    {
...
export const FailedToSendVerificationCodeException = () =>
  new UnprocessableEntityException([
    {
...
export const ExistedEmailException = () =>
  new UnprocessableEntityException([
    {
...
export const NotFoundEmailException = () =>
  new UnprocessableEntityException([
    {
...
// 2FA related errors
export const AlreadyEnabled2FAException = () =>
  new UnprocessableEntityException([
    {
...
export const NotEnabled2FAException = () =>
  new UnprocessableEntityException([
    {
...
export const InvalidTOTPException = () =>
  new UnprocessableEntityException([
    {
...
export const InvalidTOTPAndLoginVerificationCodeException = () =>
  new UnprocessableEntityException([
    {
      message: 'Error.InvalidTOTP',
      path: TOTP_PATH,
...
export const MissingVerificationMethodException = () =>
  new UnprocessableEntityException([
    {
