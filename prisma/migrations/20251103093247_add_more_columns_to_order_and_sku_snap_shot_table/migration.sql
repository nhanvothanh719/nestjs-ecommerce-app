/*
  ...
  - Added the required column `skuImage` to the `ProductSKUSnapshot` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "skuImage" TEXT NOT NULL,
